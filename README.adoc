...
`audio/muse-sequecer`, `audio/traverso` or `audio/zrythm`.
...
Synthesizers and Samplers:: I don't use any standalone synthesizers, but
searching the packages for "synth" will give you a starting point. But I often
use `audio/hydrogen` to prototype MIDI drum tracks.
